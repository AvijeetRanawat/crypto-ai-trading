...
class Config:
    ...
    PRICE_FEED_INTERVAL_SECONDS = _env_int("PRICE_FEED_INTERVAL_SECONDS", 5)
    STRATEGY_BAR_INTERVAL_SECONDS = _env_int("STRATEGY_BAR_INTERVAL_SECONDS", 60)
    COOLDOWN_MINUTES = _env_int("COOLDOWN_MINUTES", 5)
    DASHBOARD_WARMUP_MIN_TICKS = _env_int("DASHBOARD_WARMUP_MIN_TICKS", 8)
    PRO_SIGNAL_VOTERS = _env_int("PRO_SIGNAL_VOTERS", 8)
    ...
    # ── Evaluation Gates (GO / NO_GO) ──
    EVAL_MIN_RUNTIME_HOURS = _env_float("EVAL_MIN_RUNTIME_HOURS", 72.0)
    EVAL_MAX_ENGINE_ERRORS = _env_int("EVAL_MAX_ENGINE_ERRORS", 0)
    EVAL_MAX_LLM_TO_GROSS_POS_PNL_PCT = _env_float("EVAL_MAX_LLM_TO_GROSS_POS_PNL_PCT", 10.0)
    EVAL_MIN_CLOSED_TRADES = _env_int("EVAL_MIN_CLOSED_TRADES", 150)
    EVAL_MIN_AVG_PNL_PER_TRADE = _env_float("EVAL_MIN_AVG_PNL_PER_TRADE", 0.0)
